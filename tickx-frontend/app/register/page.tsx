    ...
    <main className="min-h-screen bg-black text-white flex items-center justify-center p-8 font-sans">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-400">Create a new account to secure your seats.</p>
        </div>
        ...
        <p className="text-center mt-8 text-zinc-500">
          Already have an account? <Link href="/login" className="text-indigo-400 hover:text-indigo-300 underline font-bold">Login here</Link>
        </p>
